...
### 13. Speed tiers
A level-50 speed ladder mixing your team with the metagame — who moves before whom. Your members (highlighted) use their **saved spread, nature, and item** (Choice Scarf ×1.5 etc.); meta Pokémon show their most common ladder spread's speed (falling back to max-invested). A **search box** looks up any Pokémon across all tiers and shows its full benchmark set (common ladder spread, max-invested, uninvested) alongside your highlighted members. A **weather selector** applies ability speed doubling (Rain→Swift Swim, Sun→Chlorophyll, Sand→Sand Rush, Snow→Slush Rush) to both sides — your members use their selected ability, meta Pokémon their ladder-common one (so ladder Basculegion, which runs Adaptability, correctly gets no rain boost). A **Tailwind toggle** doubles your side's speeds, ties are visually grouped, and the list is trimmed to what matters: everything faster than your slowest member plus a short tail below.
